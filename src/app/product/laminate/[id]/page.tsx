...
const LaminatePage = () => {
    ...
    const handleAddToCart = async () => {
        if (!isInCart && laminate) {
            await addToCart(laminate.type, laminate.id, quantity, laminate)
        }
    }
                                ...
                                <div className="inline-flex gap-4">
                                    {Array(5)
                                        ...
                                        .map((_, index) => {
                                            ...
                                            ;<div
                                                key={index}
                                                className="pointer-events-none flex items-center justify-center w-[130px] h-[103px] border border-gray-300"
                                            >
                                                <ImageOff />
                                            </div>
                                            return (
